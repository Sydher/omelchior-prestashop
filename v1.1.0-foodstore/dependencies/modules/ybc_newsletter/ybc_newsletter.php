...
class Ybc_newsletter extends Module
{
    ...
    public function __construct()
	{
        ...
        $this->templates = array(
            ...
            'ynpt6' => array(
                ...
                'YBC_NEWSLETTER_POPUP_TITLE' => $this->l('Welcome to our store!'),
                'YBC_NEWSLETTER_POPUP_SUBTITLE' => '',
            ...
            'ynpt8' => array(
                'YBC_NEWSLETTER_POPUP_CONTENT' => isset($data->YBC_NEWSLETTER_POPUP_CONTENT) ?  (string)$data->YBC_NEWSLETTER_POPUP_CONTENT : '',
                'YBC_NEWSLETTER_POPUP_BUTTON_COLOR' => '#f82e56',
                'YBC_NEWSLETTER_POPUP_TITLE' => $this->l('Welcome to '),
                'YBC_NEWSLETTER_POPUP_SUBTITLE' => 'the cosmetics',
        ...
        $this->configs = array(
            ...
            'YBC_NEWSLETTER_POPUP_TITLE' => array(
                'label' => $this->l('Title'),
                'type' => 'text',
                'default' => $this->templates['ynpt8']['YBC_NEWSLETTER_POPUP_TITLE'],
                'lang' => true,
            ), 
            'YBC_NEWSLETTER_POPUP_SUBTITLE' => array(
                'label' => $this->l('SubTitle'),
                'type' => 'text',
                'default' => $this->templates['ynpt8']['YBC_NEWSLETTER_POPUP_SUBTITLE'],
                'lang' => true,
            ),
    ...
    public function _installDb()
    {
        ...
        if(file_exists(dirname(__FILE__).'/views/img/temp/ynpt8.jpg'))
            @copy(dirname(__FILE__).'/views/img/temp/ynpt8.jpg', dirname(__FILE__).'/views/img/config/ynpt8.jpg');
        if($languages)
        {
            foreach($languages as $lang)
            {
