...
class Ybc_themeconfig extends Module
{
    ...
    public function __construct()
	{
       ...
       $this->configs = array(
            ...
            'YBC_TC_FIND_MAP_1' => array(
                'label' => $this->l('Find us on map title'),
                'type' => 'text',
                'desc' => $this->l('Display lable find on us map'), 
                'group' => 'ybc_tab_header',
                'default' => 'Find us on map',
                'lang' => true,
                'client_config' => true,
            ),
            'YBC_TC_FIND_MAP_LINK_1' => array(
                'label' => $this->l('Find us on map link'),
                'type' => 'text',
                'desc' => $this->l('Link to find on us map'), 
                'group' => 'ybc_tab_header',
                'default' => 'https://www.google.co.in/maps/place/Prestashop+India+:+eCommerce+Store+Development+Company/@28.4138162,77.0401069,17z/data=!3m1!4b1!4m5!3m4!1s0x390d229af9aa0637:0x398d5112de58823a!8m2!3d28.4138162!4d77.0422956',
                'validate' => 'isString',
            ),    
				...
				'options' => array(
        			 'query' => array(                             
                            array(
                                ...
                                'slides' => array(1,2,3),
                                'widgets' => array(73,74,75,76,77,78),
                                'menus' => array(1,2,3,4,5,6,7,8),
                            ),
                        ),                             
                     'id' => 'id_option',
        			 'name' => 'name'  
            ...
            'YBC_TC_WELCOME_TEXT' => array(                
                'label' => $this->l('Footer description'),				
                'lang' => true,
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',                
                'default' => 'Lorem ipsum dolor sit amet, consectetur adip <br/>
                        iscing elit. Integer nec odio. Praesent <br/> 
            ...
            'YBC_TC_COPYRIGHT_TEXT' => array(                
                ...
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',                
                'default' => 'Copyright 2017 <a href="#">Food Store Co., LTD.</a>  All rights reserved',
            ), 
            ...
            'YBC_TC_FONT1_DATA' => array(                
                ...
                'separator' => true,   
                'data_type' => 'font',    
                'default' => 'https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700',
                'validate' => 'isString',                              
            ),              
    ...
    public function hookDisplayHeader()
    {
        ...
        $this->context->controller->addJS($this->_path.'js/jquery.fancybox_forps17.js');
