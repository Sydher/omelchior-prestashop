                            ...
                            {if $display_related_products && $blog_post.products}
                                <div id="ybc-blog-related-products" class="">
                                    ...
                                    <div class="ybc-blog-related-products-wrapper ybc-blog-related-products-list">
                                        <ul class="owl-carousel blog-product-list product_list grid row ybc_related_products_type_{if $blog_related_product_type}{$blog_related_product_type|escape:'html':'UTF-8'}{else}default{/if}">
                                    ...
                                    {if count($comments)}
                                        ...
                                        <ul class="blog-comments-list">
                                            {foreach from=$comments item='comment'}
                                                    ...
                                                    {if $comment.name}<span class="comment-by">{l s='By : ' mod='ybc_blog_free'}<b>{ucfirst($comment.name)|escape:'html':'UTF-8'} {ucfirst($comment.name)|escape:'html':'UTF-8'}</b></span>{/if}
                        ...
                        {if $blog_post.related_posts}
                            <div class="{if $blog_post.related_posts|count lte 3}no_action{/if} ybc-blog-related-posts custom_nav_icon ybc_blog_free_related_posts_type_{if $blog_related_posts_type}{$blog_related_posts_type|escape:'html':'UTF-8'}{else}default{/if}">
                                ...
                                <div class="ybc-blog-related-posts-wrapper">
                                    <ul class="owl-carousel ybc-blog-related-posts-list">
